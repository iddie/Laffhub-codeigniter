...
#$url = 'http://34.224.189.244:15015/cgi-bin/sendsms=';#http://144.217.72.146:15015
$url = 'http://144.217.72.146:13013/cgi-bin/sendsms';#http://144.217.72.146:15015

$data = array('username' => $Username, 'password' => $Password, 'smsc' => 'AIRTEL', 'to' => $msisdn,'from' => 'LaffHub', 'text' =>urlencode($message));
