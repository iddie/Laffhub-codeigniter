	...
	public function UnsubscribeUser()
	{
		...
		if ($query->num_rows() > 0 )#There is active subscription
		{
			...
			$result_msg=$this->getdata_model->SendAirtelSubScriptionMessage($msisdn,$message);
			 ...
			 {				 
				$Msg="Unsubscription was successful. Details: Network => ".$network."; MSISDN => ".$msisdn."; Service Plan => ".$plan."; Subscription Id => ".$subscriptionId."; Email => ".$email;
			 }else
			 {
				$Msg="Unsubscription was successful. Details: Network => ".$network."; MSISDN => ".$msisdn."; Service Plan => ".$plan."; Subscription Id => ".$subscriptionId."; Email => ".$email;
			 }			
		...
		}else
		{
			...
			$ret="Your attempt to unsubscribe from Laffhub ".strtoupper($plan)." plan failed. You have no active subscription on Laffhub service.<br>Text <b>YES to 2001</b> to activate 7dys/15 videos. Service costs N100";
