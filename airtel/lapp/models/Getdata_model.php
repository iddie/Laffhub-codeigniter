...
class Getdata_model extends CI_Model
{
	...
	{
		//return '2348023351689'; #REMOVE LATER
		...
		}elseif (getenv('HTTP-X-UP-CALLING-LINE-ID'))
		{
			$ph=strip_tags($this->CleanPhoneNo(getenv('HTTP-X-UP-CALLING-LINE-ID')));
	...
	public function GetNetwork_bak()
	{
		...
		return $this->InternetSource($result->org,$result->countryCode,$result->isp);
	}
