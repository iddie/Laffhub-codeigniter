            ...
            $(document).ready(function(e)
            {
                ...
                function LoadPlanDetails(network,plan)
                {
                    try
                    {
                        ...
                        $.ajax({
                            url: '<?php echo site_url('AirtelCampaignBigEyes/LoadPlanDetails'); ?>',
                            type: 'POST',
                ...
                function DisplayHistory(msisdn,sdt,edt,network)
                {
                    ...
                    try
                    {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('AirtelCampaignBigEyes/LoadSubscriptionHistory'); ?>",
                            data: mydata,
                            type: 'POST',
                            dataType: 'json',
                            beforeSend: function(){
                ...
                function Subscribe(input)
                {
                    ...
                    if (input === true)
                    {
                        ...
                        //Initiate POST
                        var uri = "<?php echo site_url('AirtelCampaignBigEyes/SubscribeUser');?>";
                        ...
                        xhr.onreadystatechange = function() {
                            ...
                            if (xhr.readyState == 4 && xhr.status == 200)
                            {
                                ...
                                if (res.toUpperCase()=='OK')
                                {
                                    ...
                                    alert(m, 'LaffHub Message');
                                    setTimeout(function() {
                                        var url="<?php echo site_url('c-5a12a31d25090572256769'); ?>";
