                        ...
                        <div class="tab-content">
                            ...
                            <div>
                                <div class="form-group" style="margin-top:30px;">
                                    <div class="col-sm-offset-2 col-sm-7">
                                        <button title="Add Subscription" id="buttonSubscribe" type="button" class="btn btn-success" role="button" style="text-align:center;"><i class="fa fa-credit-card-alt"></i>Activate</button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3" title="Enable Auto-Billing">
                                    <div class="col-sm-3">
                                        <input type="hidden" class="form-control nobold" id="cboAutoBilling" title="Subscription Expiry Date" value="0">
                                    </div>
            ...
            $(document).ready(function(e)
            {
                ...
                function LoadPlans(network)
                {
                    ...
                    if(Network == 'Airtel') {
                        ...
                        plan = $('#cboPlan').val("Airtel_Promo");
                    }

                    if( plan.val() == 'Airtel_Promo') {
                        $('#lblDuration').html('');
                        $('#lblVideoCount').html('');
                        $('#lblAmount').html('');
                ...
                function LoadPlanDetails(network,plan)
                {
                    try
                    {
                        ...
                        $.ajax({
                            url: '<?php echo site_url('AirtelPromo/LoadPlanDetails'); ?>',
                            type: 'POST',
             ...
             $('#imgSubscribe').click(function(e) {
                ...
                function Subscribe(input)
                {
                    ...
                    if (input === true)
                    {
                        ...
                        //Initiate POST
                        var uri = "<?php echo site_url('AirtelPromo/SubscribeUser');?>";
                        ...
                        xhr.onreadystatechange = function() {
                            ...
                            if (xhr.readyState == 4 && xhr.status == 200)
                            {
                                ...
                                {
                                    m='You Have Successfully activated your Airtel 15 Days Free access to watch hilarious comedy clips on LaffHub';
                                ...
                                }else if (res.indexOf("active promo plan") >= 0)
                                {
                                    m=res;
                                    bootstrap_alert.warning(m);
                                    alert(m, 'LaffHub Message');
