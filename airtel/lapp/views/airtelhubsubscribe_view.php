                                ...
                                <div id="tabData" class="row tab-pane fade in active ">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="img-responsive">
                                            <img src="<?php echo base_url(); ?>acss/images/akpororoairtelhub.jpg" class="img-responsive"id="imgSubscribe"/>
                                        </div>
                                        ...
                                        <div>
                                            <div class="form-group" style="margin-top:30px;">
                                                <div class="col-sm-offset-2 col-sm-7">
                                                    <button title="Add Subscription" id="btnSubscribe" type="button" class="btn btn-success" role="button" style="text-align:center; width:120px;"><i class="fa fa-credit-card-alt"></i> Continue</button>
            ...
            $(document).ready(function(e)
            {
                ...
                function LoadPlanDetails(network,plan)
                {
                    try
                    {
                        ...
                        $.ajax({
                            url: '<?php echo site_url('AirtelHubSubscribe/LoadPlanDetails'); ?>',
                            type: 'POST',
                ...
                function DisplayHistory(msisdn,sdt,edt,network)
                {
                    ...
                    try
                    {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('AirtelHubSubscribe/LoadSubscriptionHistory'); ?>",
                            data: mydata,
                            type: 'POST',
                            dataType: 'json',
                            beforeSend: function(){
                ...
                function Subscribe(input)
                {
                    ...
                    if (input === true)
                    {
                        ...
                        //Initiate POST
                        var uri = "<?php echo site_url('AirtelHubSubscribe/SubscribeUser');?>";
                        ...
                        xhr.onreadystatechange = function() {
                            ...
                            if (xhr.readyState == 4 && xhr.status == 200)
                            {
                                ...
                                if (res.toUpperCase()=='OK')
                                {
                                    ...
                                    alert(m, 'LaffHub Message');
                                    setTimeout(function() {
                                        var url="<?php echo site_url('c-5a159494ed40b972897246'); ?>";
