...
<div class="page__layout">
                            ...
                            <div id="tabData" class="row tab-pane fade in active ">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="img-responsive">
                                        <img src="<?php echo base_url(); ?>acss/images/airtelvas.jpg" class="img-responsive" id="imgSubscribe"/>
                                    </div>
                                    <br>
    ...
    <script>
        (function($){
            ...
            var SubscriptionId= "AirtelVAS-" + '<?php echo strtoupper(substr(md5(uniqid(mt_rand(), true)) , 0, 10)); ?>';
            ...
            $(document).ready(function(e)
            {
                ...
                function LoadPlanDetails(network,plan)
                {
                    try
                    {
                        ...
                        $.ajax({
                            url: '<?php echo site_url('AirtelVAS/LoadPlanDetails'); ?>',
                            type: 'POST',
                ...
                function DisplayHistory(msisdn,sdt,edt,network)
                {
                    ...
                    try
                    {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('AirtelVAS/LoadSubscriptionHistory'); ?>",
                            data: mydata,
                            type: 'POST',
                            dataType: 'json',
                            beforeSend: function(){
             ...
             $('#imgSubscribe').click(function(e) {
                ...
                function Subscribe(input)
                {
                    ...
                    if (input === true)
                    {
                        ...
                        //Initiate POST
                        var uri = "<?php echo site_url('AirtelVAS/SubscribeUser');?>";
