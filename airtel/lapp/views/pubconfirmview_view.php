    ...
    <div class="container"> 
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="<?php echo site_url('Pubhome');?>"><i class="fa fa-sign-in"></i> Login</a></li>
        </ul>
      </div>
      <!-- /.navbar-collapse --> 
    </div>
      ...
      <div class="login-form">
     	<div class="<?php echo $PanelTheme; ?>">
              ...
              <div class="panel-heading size-20"><?php echo $ConfirmTitle; ?></div>
               ...
               <a id="btnSignIn" title="Back To Home Page" style="width:auto; background-color:#265A88" href="<?php echo site_url('Pubhome'); ?>" class="btn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-home"></i> Home&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </a>
