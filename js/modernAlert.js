    ...
    this.modernAlert = function () {
        var modernAlert = {
            ...
            alert : function () {
                ...
                html = '<h4>'+args.title+'</h4><p>'+args.msg + '</p><br><input style="color:#fff; background-color:#f0ad4e; border-color:#eea236; text-shadow:0 -1px 0 rgba(0,0,0,0.2); -webkit-box-shadow: inset 0 1px 0 rgba(255,255,255,0.15),0 1px 1px rgba(0,0,0,0.075); box-shadow: inset 0 1px 0 rgba(255,255,255,0.15),0 1px 1px rgba(0,0,0,0.075); display:inline-block; padding:9px 12px; padding-top:7px; margin-bottom:0; font-size:14px; line-height:20px; text-align:center; vertical-align:middle; cursor:pointer; -webkit-border-radius:3px; -webkit-border-radius:3px; -webkit-border-radius:3px; background-image:none !important; border:none; text-shadow:none; box-shadow:none; transition:all 0.12s linear 0s !important; font:14px/20px \"Helvetica Neue\",Helvetica,Arial,sans-serif; margin-right:5px; min-width:120px; margin-bottom:8px;" onclick="modernAlert.close(\''+ id + '\')" type="button" value="'+ args.buttons.ok +'" />';
            ...
            confirm : function () {
				...
				'<br><input style="color:#fff; background-color:#5cb85c; border-color:#4cae4c; text-shadow:0 -1px 0 rgba(0,0,0,0.2); -webkit-box-shadow: inset 0 1px 0 rgba(255,255,255,0.15),0 1px 1px rgba(0,0,0,0.075); box-shadow: inset 0 1px 0 rgba(255,255,255,0.15),0 1px 1px rgba(0,0,0,0.075); display:inline-block; padding:9px 12px; padding-top:7px; margin-bottom:0; font-size:14px; line-height:20px; text-align:center; vertical-align:middle; cursor:pointer; -webkit-border-radius:3px; -webkit-border-radius:3px; -webkit-border-radius:3px; background-image:none !important; border:none; text-shadow:none; box-shadow:none; transition:all 0.12s linear 0s !important; font:14px/20px \"Helvetica Neue\",Helvetica,Arial,sans-serif; margin-right:5px; min-width:120px; margin-bottom:8px;" class="maYes" type="button" value="'+ args.buttons.ok +'" />\n'+
				'<input style="color:#fff; background-color:#d9534f; border-color:#d43f3a; text-shadow:0 -1px 0 rgba(0,0,0,0.2); -webkit-box-shadow: inset 0 1px 0 rgba(255,255,255,0.15),0 1px 1px rgba(0,0,0,0.075); box-shadow: inset 0 1px 0 rgba(255,255,255,0.15),0 1px 1px rgba(0,0,0,0.075); display:inline-block; padding:9px 12px; padding-top:7px; margin-bottom:0; font-size:14px; line-height:20px; text-align:center; vertical-align:middle; cursor:pointer; -webkit-border-radius:3px; -webkit-border-radius:3px; -webkit-border-radius:3px; background-image:none !important; border:none; text-shadow:none; box-shadow:none; transition:all 0.12s linear 0s !important; font:14px/20px \"Helvetica Neue\",Helvetica,Arial,sans-serif; margin-right:5px; min-width:120px; margin-bottom:8px;" class="maNo" type="button" value="'+ args.buttons.cancel +'" />';
            ...
            prompt : function () {
                ...
                <input class="button btn btn-success maYes" type="button" value="'+ args.buttons.ok +'" />\n\
                <input class="button btn btn-danger maNo" type="button" value="'+ args.buttons.cancel +'" />';
