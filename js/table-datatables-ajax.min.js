        ...
        e = function () {
            ...
            a.init({
                ...
                dataTable: {
                    ...
                    pageLength: 10,
                    ajax: {
                        url: _app_url + "api/connect_videos"
                    },
                    columns: [
                        {"data":null,"defaultContent":'<label class="mt-checkbox mt-checkbox-single'+
                        'mt-checkbox-outline"> <input type="checkbox" class="group-checkable"'+
                        'data-set="#sample_2 .checkboxes" /> <span></span></label>'},
                        {data: 'id'},
                ...
                "" != t.val() && a.getSelectedRowsCount() > 0 ? (a.setAjaxParam("customActionType", "group_action"),
                 a.setAjaxParam("customActionName", t.val()), a.setAjaxParam("id", a.getSelectedRows()),
                  a.getDataTable().ajax.reload(), a.clearAjaxParams()) : "" == t.val() ?
                   App.alert({
                    type: "danger",
                    icon: "warning",
