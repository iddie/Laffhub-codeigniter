            ...
            <nav class="header__nav">
              <ul class="header__nav-list">
                <li class="header__nav-item">
                  <a href="<?php echo site_url('Subscriberhome'); ?>" class="header__nav-link"> Home</a>
                </li>
          ...
          <div class="header__right" style="margin-top:20px;">
            <div class="dropdown lng-dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="header__nav-link"><span style="color:#E5B400; font-weight:bold;">Phone: <?php echo $Phone; ?> </span></a></li>
              </ul>
