                           ...
                           <div id="divFAQ">
                                <ul class="collapsibleList">
                                  ...
                                  <li>
                                    ...
                                    <ul>
                                      <li style="text-align:justify;">It is available to pre-paid customers only.</li>
                                    </ul>
                                  </li>
                                  ...
                                  <li>
                                    ...
                                    <ul>
                                      <li style="text-align:justify;">The only available package for MTN customer is the weekly plan which cost N50 per week.</li>
                                    </ul>
                                  </li>
                                  ...
                                  <li>
                                    ...
                                    <ul>
                                      <li style="text-align:justify;">Yes, you need a data plan to access LaffHub.</li>
                                    </ul>
                                  </li>
                                  ...
                                  <li>
                                    How is my subscription different from when I am on MTN Network and other networks?
                                    <ul>
                                      <li style="text-align:justify;">MTN customers can only enjoy the weekly Laffhub plan.</li>
                                    </ul>
                                  </li>
