...
<html lang="en">
  <head>
    ...
    <script src="<?php echo base_url();?>js/ie10-viewport-bug-workaround.js">
            ...
            <div class="hero-slider-wrap scrollreveal scrollAnimateHeroSlider">
              <div class="hero-slider">
                <div class="sld">
                  <div class="hero-slider__slide">
                    <div class="hero-slider__slide-image">
                      <a href="<?php echo base_url(); ?>Subscribe"><span class="hero-slider__lazy-load-img" data-original="<?php echo base_url(); ?>acss/images/homepage.png"></span></a>
                    </div>
                    <div class="container">
                          ...
                          <div class="hero-slider__slide-left">
                            <div class="hero-slider__slide-text">
                              <div class="hero-slider__button">
                                <a class="js-ajax-link">  </a><!--Watch now-->
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="sld">
                  <div class="hero-slider__slide">
                    <div class="hero-slider__slide-image">
                      <span class="hero-slider__lazy-load-img" data-original="<?php echo base_url(); ?>acss/images/ad12.jpg"></span>
                    </div>
                    <div class="container">
                      <div class="row row--flex">
                        <div class="col-xxl-6 col-xl-7">
                ...
                <div class="sld">
                  <div class="hero-slider__slide">
                    <div class="hero-slider__slide-image">
                      <span class="hero-slider__lazy-load-img" data-original="<?php echo base_url(); ?>acss/images/ad13.jpg"></span>
                    </div>
                    <div class="container">
                      <div class="row row--flex">
                        <div class="col-xxl-6 col-xl-7">
                ...
                <div class="sld">
                  <div class="hero-slider__slide">
                    <div class="hero-slider__slide-image">
                      <span class="hero-slider__lazy-load-img" data-original="<?php echo base_url(); ?>acss/images/ad14.jpg"></span>
                    </div>
                    <div class="container">
                      <div class="row row--flex">
                        <div class="col-xxl-6 col-xl-7">
                ...
                <div class="sld">
                  <div class="hero-slider__slide">
                    <div class="hero-slider__slide-image">
                      <span class="hero-slider__lazy-load-img" data-original="<?php echo base_url(); ?>acss/images/ad15.jpg"></span>
                    </div>
                    <div class="container">
                      <div class="row row--flex">
                        <div class="col-xxl-6 col-xl-7">
