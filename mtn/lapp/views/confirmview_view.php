      ...
      <div class="login-form">
     	<div class="<?php echo $PanelTheme; ?>">
              ...
              <div class="panel-heading size-20"><?php echo $ConfirmTitle; ?></div>
               ...
               <a id="btnSignIn" title="Back To Home Page" style="width:auto; background-color:#265A88" href="<?php echo site_url('Home'); ?>" class="btn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-home"></i> Home&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </a>
