...
<div class="carousel-caption" >
        <div class="login-form">
          <form>
            ...
            <p style="color:#85b140; text-shadow: 0 0px 0px rgba(0,0,0,.6);" class="text-centre"> Forgot password? <a class="redtext" href="<?php echo site_url('Forgot'); ?>">Click Here</a> </p>
            <button id="btnLogin" type="button" class="btn btn-default" style="font-size:20px;"><i class="fa fa-sign-in"></i> Login</button>
            ...
            <div align="center" class="sign-up">
            	<button type="button" style="background-color:#3b5998; text-align:center; color:#ffffff; " id="btnFacebookLogin" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook-official size-20" style="margin-top:10px;"></i> Login With Facebook </button>
             </div>
             
          </form>
          <div class="login-social"> </div>
          <p style="color:#333; text-shadow: 0 0px 0px rgba(0,0,0,.6); padding-right:5px; margin-top:10px;" > Don't have an account ? <a href="<?php echo site_url('Signup');?>" style="top:0px;"><span style="color:#85b140; text-shadow: 0 0px 0px rgba(0,0,0,.6);">Sign Up </span> </a></p>
			...
			<div class="form-group">
                ...
                <p align="center" title="Go to publisher page if you are a publisher or want to be a publisher." style="color:#333; text-shadow: 0 0px 0px rgba(0,0,0,.6); padding-right:5px; text-align:center" ><a href="<?php echo site_url('Pubhome');?>" style="top:0px;"><span style="text-shadow: 0 0px 0px rgba(0,0,0,.6); color:#db5832" >Publisher Login </span> </a></p>
			</div>
        </div>
      </div>
