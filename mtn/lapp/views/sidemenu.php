 ...
 <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<?php 
                if (($CurrentPage=='Editprofile') or ($CurrentPage=='Editpassword'))
                {
          ...
          <?php 
           ...
           ####################### END NETWORK SETTINGS ################################
			...
			if (($CurrentPage=='Logreport') or ($CurrentPage=='Dailyrevenue'))
			{
				echo '<li class="treeview active">';
			}else
			{
        ...
        <?php		 
			######################################################################
			if (($CurrentPage=='Htmlhelp') or ($CurrentPage=='Pdfhelp'))
			{
				echo '<li class="treeview active">';
			}else
			{
