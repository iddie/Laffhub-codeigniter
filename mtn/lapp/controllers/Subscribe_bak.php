	...
	public function SubscribeUser()
	{
		...
		}else
		{
			...
			}else
			{
				...
				$transid=''; $cptransid=''; $errormessage=''; $subscription_status=''; $errorCode='';
...
#$result=array('Status' => 'OK','errorCode' => '','errorMessage' =>'', 'TransId' => '');
#return array('Status' => 'FAILED','errorCode' => $code,'errorMessage' => '');
				...
				{#return array('Status' => 'FAILED','errorCode' => $code,'errorMessage' => $msg);
					...
					{
						if (trim(strtoupper($ret['errorCode']))<>'02')
						{
							$new='0';
					...
					$Msg="Subscription was not successful. Details: Network => ".$network."; MSISDN => ".$msisdn."; Service Plan => ".$plan."; Duration => ".$duration."; Amount => ".$amount."; Subscription Date => ".$subscribe_date."; Expiry Date => ".$exp_date."; Error Code => ".$errorCode."; Error Message => ".$errormessage;
					
					$subscription_message=$errormessage;
