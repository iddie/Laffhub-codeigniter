			...
			}else
			{
				...
				if (strtolower($exist) <> 'active')
				{
					...
					if (intval($isnew,10)==1)
					{
						#Create new account
						##################################################
						$this->getdata_model->CreateNewMTNAccount($network,$phone,date('Y-m-d'),'Trial',2);
				...
				}else
				{
					...
					if ($query->num_rows() == 0 )#New User
					{
						...
						if (intval($isnew,10)==1)
						{
							#Create new account
							##################################################
							$this->getdata_model->CreateNewMTNAccount($network,$phone,date('Y-m-d'),$plan,7);
