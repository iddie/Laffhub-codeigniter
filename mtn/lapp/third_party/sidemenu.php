        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
              <div class="pull-left label" style="font-size:14px;">	  	
                <span class="label label-danger left size-14"><a href="<?php echo site_url("Logout"); ?>" style="color:#F2DEDE;">&nbsp;&nbsp;&nbsp&nbsp;Sign Out&nbsp;&nbsp;&nbsp&nbsp;</a></span>
              </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header">PORTAL ADMIN</li>
             ...
             <?php
				if (($CurrentPage=='Activatevideo') or ($CurrentPage=='Publishers') or ($CurrentPage=='Previewvideo'))
				{
					echo '<li class="treeview active">';
				}else
				{
