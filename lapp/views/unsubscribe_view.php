			...
			try
			 {
				...
				if (!SubscriberEmail)
				{
					m='Subscriber email has not been displayed. Please make sure you have active internet connection. You may also sign out and sign in again. If this persists, contact our support at <a href="mailto:support@efluxz.com">support@efluxz.com</a>.';
					bootstrap_alert.warning(m);					
					alert(m, 'LaffHub Message');
					setTimeout(function() {
						$('#divAlert').fadeOut('fast');
				...
				m='Are you sure you want to unsubscribe from LaffHub '+pl.toUpperCase()+' plan? (Click <b>Yes</b> to proceed or <b>No</b> to abort)?';
			...
			if (input === true)
			{
				...
				xhr.onreadystatechange = function() {
					...
					if (xhr.readyState == 4 && xhr.status == 200)
					{
						...
						if (res=='OK')
						{
							m='You Have Successfully Unsubscribed From LaffHub <b>'+pl.toUpperCase()+'</b> Plan.';
