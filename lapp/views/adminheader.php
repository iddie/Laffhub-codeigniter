          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
			   ...
			   <li class="dropdown user user-menu" title="User Role">
                <a href="#" class="dropdown-toggle yellowtext" data-toggle="dropdown">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu btn-primary">
                  ...
                  <li class="user-body" title="Username">
                    <p><b>Username:</b> <?php echo '<span class="yellowtext"><b>'.$username.'</b></span>'; ?></p>
                  </li>
                  
                   <!-- Fullname -->
                  <li class="user-body" title="User FullName">
                    <p><b>Full Name:</b> <span id="spnUserFullname1"><?php echo '<span class="yellowtext"><b>'.$UserFullName.'</b></span>'; ?></span></p>
                  </li>
                  
                 <!--Role-->
				 <li class="user-body"  title="User Role">  	
                    <p><b>Role:</b> <?php echo '<span class="yellowtext"><b>'.$role.'</b></span>'; ?></p>
                </li>
                     <!--Category End-->          
                  <!-- Menu Footer-->
