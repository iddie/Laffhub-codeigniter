...
(function($){
	...
	var Comedian='<?php echo $Comedian; ?>';
	...
	$(document).ready(function(e) {
		...
		$('#btnNext').click(function(e) {
            try
			{
				...
				$.redirect("<?php echo site_url('Comedian/GetComedian');?>",{comedian: Comedian, page:page}); 
                  ...
                  <div class="section-heading">
                    <h4>
                    	<?php
							...
							if (count($ComedianVideos)<2) $tit=$Comedian.' Video'; else $tit=$Comedian.' Videos';
							...
							foreach($ComedianVideos as $row):
								if (trim($row->video_code) and trim($row->thumbnail))
								{
									...
									$likescnt=0; $likestotal=0;
								 	...
								 	if (($row->comedian) and (strtolower($row->comedian)<>'undefined')) $comedian=ucwords(strtolower($row->comedian));
