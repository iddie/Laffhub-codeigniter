...
<head>
    ...
    <title>LaffHub | Failed Activations Report</title>
...
<?php include('homelink.php'); ?>    
    ...
    <script type="text/javascript">	
		...
		var table;
		var Title='<font color="#AF4442">Failed Activations Report Help</font>';
		var m='';
		...
		$(document).ready(function(e)  
		{
			...
			$('#btnExcel').click(function(e) 
			{
                try
				{
					...
					$.ajax({
						url: '<?php echo site_url('Failedactivations/PrintReport'); ?>',
						data: mydata,
						type: 'POST',
						dataType: 'text',
						...
						success: function(data,status,xhr) {				
							...
							if (d==('failedactivationsreport.xls'))
							{
								window.open('<?php echo base_url();?>reports/failedactivationsreport.xls')
							}else
							{
								m=d;
			...
			function DisplayReport(sdt,edt,network)
			{
				try
				{
					$.blockUI({message:'<img src="<?php echo base_url();?>images/loader.gif" /><p>Retrieving Failed Activations Records. Please Wait...</p>',theme: true,baseZ: 2000});
					...
					$.ajax({
						url: "<?php echo site_url('Failedactivations/GetReport'); ?>",
						data: mydata,
						type: 'POST',
						dataType: 'json',
						complete: function(xhr, textStatus) {					
						...
						success: function(dataSet,status,xhr) {
							if (table) table.destroy();
								...
								table = $('#recorddisplay').DataTable( {
									...
									language: {zeroRecords: "No Failed Activation Record Found"},								
									columnDefs: [
										{
											"targets": [ 0,1,2,3,4 ],
											"visible": true,
        ...
        <section class="content">
        	<div class="row">     
              ...
              <div class="panel-heading size-16">
              	<i class="fa fa-area-chart"></i> Failed Activations Report
            ...
            <div class="panel-body">
                ...
                <ul class="nav nav-tabs " style="font-weight:bold;">
                	...
                	<li><a data-toggle="tab" href="#tabReport"><i class="fa fa-eye"></i> View Failed Activations</a></li>
                </ul>
    			<!--Tab Ends-->
                         ...
                         <form class="form-horizontal"> 
                           ...
                           <div class="form-group" style="margin-top:30px;">
                            <div class="col-sm-8 col-sm-offset-3">
                             <button title="Display Failed Activations Report" style="width:140px;" id="btnDisplay" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-play-circle" ></span> Display Report</button>
                    ...
                    <div id="tabReport" class="row tab-pane fade ">
                        <br> 
                         ...
                         <center>
                            ...
                            <table align="center" id="recorddisplay" cellspacing="0" title="Failed Activations Records" class="hover display table table-bordered stripe table-condensed"  style="border:solid; width:99.5%">
                                <thead style="color:#ffffff; background-color:#FF0000; ">
                                    <tr>
                                        <td style="font-weight:bold;">SN</td>
                                        <td style="font-weight:bold;">Network</td>                                        <td style="font-weight:bold;">Activation Date</td>
