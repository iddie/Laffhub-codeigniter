...
$(document).ready(function(e) {
			...
			if (newvideo==true)
			{
				...
				}else//Maxvideo reached - Stop
				{
					...
					}else
					{
						...
						m='You have reached the maximum number of videos and the maximum number of times you can watch each video for your current subscription plan. Please renew your subscription to enjoy the hilarious videos. Click <a style="position:inherit;" href="<?php echo site_url('Subscribe'); ?>">Here</a> to subscribe.';			
	...
	$('#btnComment').click(function(e) {
		...
		{			
			...
			var em='<?php echo $subscriber_email; ?>';			
			var cm=$.trim($('#txtComment').val());
			var pid='0'; //Parent Id
...
function DislikeComment(btn)
{
	try
	{
		...
		var mydata={email:'<?php echo $subscriber_email; ?>', phone:Phone, comment_id:cid}; 							  
...
function LikeComment(btn)
{
	...
	{
		var cid=$('#'+btn.id).attr('data-commentid'); //Comment Id		
		var mydata={email:'<?php echo $subscriber_email; ?>', phone:'<?php echo $Phone; ?>', comment_id:cid}; 
