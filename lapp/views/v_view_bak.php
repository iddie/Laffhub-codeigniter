...
$(document).ready(function(e) {
	...
	$('#btnComment').click(function(e) {
        try
		{
			...
			//Add Comment
			var mydata={email:SubscriberEmail, phone:Phone, category:cat, filename:fn, videocode:cd, name:SubscriberName, comment:cm, videotitle:vt};
                                                ...
                                                echo '
                                                    <div class="row">
														...
														<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="margin-left:-30px;">
															<h5 style="text-transform:capitalize; font-size:13px;"><b>'.$row->name.'</b><span style="float:right">'.date('D, d M Y H:i',strtotime($row->commentdate)).'</span></h5>
